                ...
                <div className='mt-5'>
                    ...
                    <from className='w-full text-gray-600 mt-7 '>
                        ...
                        <div className='w-full pb-4 mt-8 mb-4 border-b-2'>
                            <h1 className='mt-1 text-xl font-semibold'>Pengetahuan Orang Tua Tentang Anak</h1>
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            >
                                Apakah bapak ibu siap untuk berkomunikasi dengan wali kelas menghadiri rapat awal tahun mengambil raport hasil belajar siswa dan menghadiri panggilan sekolah dalam pendampingan belajar siswa selama siswa menjadi siswa SMK negeri Indonesia 2
                            </label>
                            <input
                                type="text"
                                id="siap"
                        ...
                        {/* //? Bagian 4 */}
                        <div className='w-full pb-4 mt-8 mb-4 border-b-2'>
                            <h1 className='mt-1 text-xl font-semibold'>Pengetahuan Orang Tua Tentang Anak
                            </h1>
                        </div>
